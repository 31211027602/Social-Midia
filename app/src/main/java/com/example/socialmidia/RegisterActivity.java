...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this)
                .asGif()
                .load(R.drawable.background) // Thay thế "your_gif_file" bằng tên tệp GIF của bạn
                .into(animatedView);
                ...
                .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            hashMap.put("bio", "");
                            hashMap.put("imageurl", "https://firebasestorage.googleapis.com/v0/b/social-midia-a0d29.appspot.com/o/placeholder.jpeg?alt=media&token=41af1d6d-33d1-49b2-949f-3aa707219ef1");
